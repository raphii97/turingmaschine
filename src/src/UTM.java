...
public class UTM {
    ...
    private void convertInputToConfiguration() {
        ...
        if (input.contains("111")) {
            code = input.split("111");
        } else {
            code[0] = "";
            code[1] = input;
        }
